    ...
    public partial class IlkOlusturma : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GalaryID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GalaryImg = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GalaryDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HomeID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HomeWelCome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomeTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomeDescriptions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomeImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LinlID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LinlName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LinlUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Links", x => x.LinlID);
                });
